...
import py_api
import resource
from user_functions import select_from_calendar, select_from_list, select_resource, check_within_experiment_time #select_plan, render, send_globus_link
...
user_proposals = py_api.get_user_proposals(user_info['userid'])
...
if use_calendar:
    ...
    current_proposal, current_experiment = select_from_list(user_proposals_experiments, 'start_time')
py_api.set_experiment(current_experiment)
